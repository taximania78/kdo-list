...
2. **Hardcoded Users**: The app currently hardcodes two users (Personne and Mathieu) in several places. When modifying user-related features, search for these names to find all references.
